...
(function (factory) {
  ...
  var factoryOutput = (() => {
    ...
    var I = { ...E, ...D };
    for (let a = 0; a < y.length; a++) y[a].name = I[y[a].iso2];
    var R = 0,
      A = {
        allowDropdown: !0,
      ...
      v = class {
        ...
        _g(t, e) {
          for (let i = 0; i < t.length; i++) {
            ...
            let r = "";
            this.d.showFlags &&
              (r += `<div class='iti__flag-box'><div class='iti__flag iti__${n.iso2}'></div></div>`),
              (r += `<span class='iti__country-name'>${n.name}</span>`),
              (r += `<span class='iti__dial-code'>+${n.dialCode}</span>`),
        ...
        _i4() {
          o.autoCountry
            ...
            : o.startedLoadingAutoCountry ||
              ((o.startedLoadingAutoCountry = !0),
        ...
        _j() {
          ...
          (this._a12 = (r) => {
            ...
            let l = r?.data && /[^+0-9]/.test(r.data),
              u = r?.inputType === "insertFromPaste" && this.a.value;
            l || (u && !t)
              ? (s = !0)
            ...
            if (e && !s && !d) {
              let h = this.a.selectionStart || 0,
                g = this.a.value.substring(0, h).replace(/[^+0-9]/g, "").length,
                m = r?.inputType === "deleteContentForward",
                C = this._9(),
                w = j(g, C, h, m);
            ...
            (t || i) &&
              ((this._handleKeydownEvent = (r) => {
                if (
                  ...
                  if (t) {
                    let l = this.a.selectionStart === 0 && r.key === "+",
                      u = /^[0-9]$/.test(r.key),
                      d = l || u,
                      h = this._6(),
                      p = o.utils.getCoreNumber(h, this.s.iso2),
                      g =
                        this.maxCoreNumberLength &&
                        p.length >= this.maxCoreNumberLength,
                      m = this.a.value.substring(
        ...
        _v(t) {
          ...
          if (r) {
            let d = this.q[b(r)],
              h = d.indexOf(this.s.iso2) !== -1 && l.length <= r.length - 1;
            if (!(n === "1" && k(l)) && !h) {
        ...
        _z(t) {
          ...
          if (
            ...
            t && i
              ...
              : ((r = "iti__flag iti__globe"), (l = n.noCountrySelected)),
              (this.l.className = r),
        ...
        _0() {
          ...
          if (o.utils && s) {
            let r = o.utils.numberType[e],
              l = this.s.iso2
                ? o.utils.getExampleNumber(this.s.iso2, i, r)
                : "";
            (l = this._7(l)),
        ...
        isValidNumberPrecise() {
          ...
          return /\p{L}/u.test(t)
            ? !1
            : o.utils
            ? o.utils.isValidNumber(t, this.s.iso2)
            : null;
        }
        setCountry(t) {
          let e = t.toLowerCase();
      ...
      F = (a) =>
        !o.utils && !o.startedLoadingUtilsScript
          ? ((o.startedLoadingUtilsScript = !0),
            new Promise((t, e) => {
